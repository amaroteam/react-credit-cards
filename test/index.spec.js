...
describe("ReactCreditCards", () => {
  ...
  it("should render properly", () => {
    ...
    expect(wrapper.find(".rccs__card").hasClass("rccs__card--unknown")).toBe(
      true
    );
  });
  ...
  it("should handle new number props (American Express)", () => {
    ...
    expect(
      wrapper.find(".rccs__card").hasClass("rccs__card--american-express")
    ).toBe(true);
  ...
  it("should handle new number props (Diners)", () => {
    ...
    expect(
      wrapper.find(".rccs__card").hasClass("rccs__card--diners-club")
    ).toBe(true);
  ...
  it("should handle new number props (Discover)", () => {
    ...
    expect(wrapper.find(".rccs__card").hasClass("rccs__card--discover")).toBe(
      true
    );
  ...
  it("should handle new number props (Hipercard)", () => {
    ...
    expect(wrapper.find(".rccs__card").hasClass("rccs__card--hipercard")).toBe(
      true
    );
  ...
  it("should handle new number props (Laser)", () => {
    ...
    expect(wrapper.find(".rccs__card").hasClass("rccs__card--laser")).toBe(
      true
    );
  ...
  it("should handle new number props (Maestro)", () => {
    ...
    expect(wrapper.find(".rccs__card").hasClass("rccs__card--maestro")).toBe(
      true
    );
  ...
  it("should handle new number props (Mastercard)", () => {
    ...
    expect(wrapper.find(".rccs__card").hasClass("rccs__card--mastercard")).toBe(
      true
    );
  ...
  it("should handle new number props (Unionpay)", () => {
    ...
    expect(wrapper.find(".rccs__card").hasClass("rccs__card--unionpay")).toBe(
      true
    );
  ...
  it("should handle new number props (Visa Electron)", () => {
    ...
    expect(
      wrapper.find(".rccs__card").hasClass("rccs__card--visa-electron")
    ).toBe(true);
